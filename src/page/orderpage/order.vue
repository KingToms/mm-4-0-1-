  ...
  <div class="order" :class="{'bgColor': page === 'coupon'}">
    ...
    <div class="main order-info" v-if="this.page === 'order'">
      <section class="service bgwhite">
        <service-type v-if="this.product_info.service_form.length === 1" :serviceImg="serviceImg" :serviceTitle="serviceTitle"></service-type>
        <div class="choose-type" v-else>
          <ul class="clear">
            <li class="left" @click="chooseService(1)">
              <div class="service-inDoor" :class="{'active': inDoor === 1}">
