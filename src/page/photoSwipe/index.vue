<template>
  <div class="photo-swipe">
    <div class="my-gallery" data-pswp-uid="1">
        <figure>
            <div class="img-dv"><a href="/static/image/search/search_pic02.png" data-size="1920x1080"><img src="/static/image/search/search_pic02.png"></a></div>
            <figcaption style="display:none;">在这里可增加图片描述</figcaption>
        </figure>
        <figure>
            <div class="img-dv"><a href="/static/image/search/search_pic03.png" data-size="1920x1080"><img src="/static/image/search/search_pic03.png"></a></div>
...
<script>
import '../../assets/photoswipe/photoswipe';
import '../../assets/photoswipe/photoswipe-ui-default';
export default {
  name: 'photoSwipe',
  data () {
    return {
