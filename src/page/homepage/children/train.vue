  ...
  <div class="main">
    ...
    <div class="swipe-wrapper">
      <mt-swipe :auto="4000">
        <mt-swipe-item>
          <a>
            <!--<img src="../../../assets/image/img/home/home_banner_class05.jpg" alt="">-->
...
export default {
  ...
  created() {
    ...
    this.funTypeList(); // 显示服务分类（512，訓練）
    this.scroll();
  },
  methods: {
    /* 显示服务分类 */
    ...
    selectType(index, type, cateId){
      ...
      if(this.cate_oldId!=cateId){ // 重复点击时，不重复调用数据（“全部”除外）
        ...
        this.makpupList = [];
        this.pageNo = 1
        if(this.Type == this.cate_id){ // 点击第二级--“全部”
          this.cate_id = '';
        }
        this.ProductList();
      }
  ...
  filters: {
    uesrImg(item) {
      if (!item) {
        return require("../../../assets/image/img/home/home_banner_class05.jpg");
      } else {
