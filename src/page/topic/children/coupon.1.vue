<template>
  <div class="confirmOrder-coupon">
    <div class="coupon-title">
      <ul class="clear">
        <li class="left"><span :class="{'bottom': isUse == 1}" @click="isUse=1">未使用({{coupon.useCoupon.length}})</span></li>
        <li class="left"><span :class="{'bottom': isUse == 2}" @click="isUse=2">不可用({{coupon.unUseCoupon.length}})</span></li>
        <li class="left"><span :class="{'bottom': isUse == 3}" @click="isUse=3">使用记录({{coupon.usedCoupon.length}})</span></li>
      </ul>
    </div>
    <div class="coupon-list">
      <div class="use-coupon" v-show="isUse==1">
      ...
      <div class="unUse-coupon" v-show="isUse==2">
      ...
      <div class="unUse-coupon" v-show="isUse==3">
        <div class="coupon-detail clear" v-for="(item,index) in coupon.usedCoupon" :key="index">
          <div class="left">
            <p>满{{item.base_amount}}可用</p>
            <p>￥<span>{{item.amount}}</span></p>
          </div>
        ...
        <div class="tip" v-if="coupon.usedCoupon.length === 0 ? true : false">
          <img src="/static/icon/order/coupon_icon_null.png">
          <p>您没有相关的优惠券</p>
        </div>
      </div>
